...
namespace Owl
{
	...
	public:
		...
		void SetPerspectiveVerticalFov(const float pVerticalFov)
		{
		...
		void SetPerspectiveNearClip(const float pNear)
		{
		...
		void SetPerspectiveFarClip(const float pFar)
		{
		...
		void SetOrthographicSize(const float pSize)
		{
		...
		void SetOrthographicNearClip(const float pNear)
		{
			m_OrthographicNear = pNear;
			RecalculateProjection();
		}

		[[nodiscard]] float GetOrthographicFarClip() const { return m_OrthographicFar; }

		void SetOrthographicFarClip(const float pFar)
		{
			m_OrthographicFar = pFar;
			RecalculateProjection();
		}
