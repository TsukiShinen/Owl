...
namespace Owl
{
	...
	public:
		...
		static void DrawQuad(const glm::mat4& pTransform, const Ref<Texture2D>& pTexture, float pTilingFactor = 1.0f, const glm::vec4& pTintColor = glm::vec4(1.0f), int pEntityId = -1);
		...
		static void DrawSprite(const glm::mat4& pTransform, const SpriteRendererComponent& pSpriteRendererComponent, int pEntityId);
